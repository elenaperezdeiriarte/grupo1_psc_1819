...
public class JFrameListaQuejasSugerencias extends JFrame implements
	...
	public JFrameListaQuejasSugerencias() {
		...
		btnLimpiarQuejas = new JButton(new ImageIcon(getClass().getResource(
				"/images/Trash_Delete.png")));
		...
		btnLimpiarSuger = new JButton(new ImageIcon(getClass().getResource(
				"/images/Trash_Delete.png")));
