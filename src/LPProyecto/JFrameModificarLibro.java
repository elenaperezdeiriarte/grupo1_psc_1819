...
public class JFrameModificarLibro extends JFrame implements ActionListener
{
	...
	public JFrameModificarLibro(ClsArticulo Articulo, int saberSiBusc, int ordenacion, String busqueda) 
	{
		...
		lblNewLabel.setIcon(new ImageIcon(JFrameMenuPrincipal.class.getResource("/images/book.png")));
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if (botonPulsado == btnGuardar)
		{
				...
				LibroaModificar.setAutor(txtLibAutor.getText());	LibroaModificar.setNombre(txtLibNombre.getText());	
