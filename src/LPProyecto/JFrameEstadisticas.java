...

{
	...
	public JFrameEstadisticas(int x) 
	{
		...
		lblNewLabel1.setIcon(new ImageIcon(JFrameMenuPrincipal.class.getResource("/images/DVD.png")));
		lblNewLabel1.setBounds(619, 11, 128, 128);
		contentPane.add(lblNewLabel1);
		
		JLabel lblNewLabel11 = new JLabel("");
		lblNewLabel11.setIcon(new ImageIcon(JFrameMenuPrincipal.class.getResource("/images/book.png")));
		...
		{	
			...
			tableDVD.setBorder(UIManager.getBorder("FileChooser.listViewBorder"));
		...
		{	
			...
			tableLibro.setBorder(UIManager.getBorder("FileChooser.listViewBorder"));
