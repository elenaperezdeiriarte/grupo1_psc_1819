...
public class JFrameVerArticulos extends JFrame implements ActionListener,
	...
	final static Logger log = Logger.getLogger(JFrameVerArticulos.class
			.getName());
	...
	public JFrameVerArticulos(int a, String Busc, int x, int adminOusu) {
		...
		if (adminOusu == 0) {
			...
			btnInsertarCD1 = new JButton(new ImageIcon(getClass().getResource(
					"/images/Add.png")));
			...
			btnInsertarDVD = new JButton(new ImageIcon(getClass().getResource(
					"/images/DVD.png")));
			...
			btnInsertarDVD1 = new JButton(new ImageIcon(getClass().getResource(
					"/images/Add.png")));
			...
			btnInsertarLibro1 = new JButton(new ImageIcon(getClass()
			...
			btestrella1 = new JButton(new ImageIcon(getClass().getResource(
			...
			btestrella2 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella3 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella4 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella5 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella6 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella7 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella8 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella9 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
			...
			btestrella10 = new JButton(new ImageIcon(getClass().getResource(
					"/images/star-empty.png")));
		...
		btnVerFichaDel = new JButton(new ImageIcon(getClass().getResource(
				"/images/detalles.png")));
		...
		JLabel lblVerMasDetalles = new JLabel(
				"Ver mas detalles del articulo\r\n");
		...
		if (a == 1) {
			...
			for (int a1 = 0; a1 < ArticuloList.size(); a1++) {
				if (ArticuloList.get(a1).getAutor().toLowerCase()
						.indexOf(Busc.toLowerCase()) != -1) {
					auxiliar.add(ArticuloList.get(a1));
				} else {
					if (ArticuloList.get(a1).getNombre().toLowerCase()
							.indexOf(Busc.toLowerCase()) != -1) {
						auxiliar.add(ArticuloList.get(a1));
					}
				}
		...
		if (ArticuloList != null) {
			...
			tableArticulos.setBorder(UIManager
	...
	public void actionPerformed(ActionEvent c) {
		...
		if (botonPulsado == btnInsertarCD || botonPulsado == btnInsertarCD1) {
			JFrameCFCD nuevoCD = new JFrameCFCD(saberSiBusc, ordenacion,
					busqueda);
		...
		if (botonPulsado == btnInsertarLibro
				|| botonPulsado == btnInsertarLibro1) {
			JFrameCFLibro nuevoLibro = new JFrameCFLibro(saberSiBusc,
					ordenacion, busqueda);
		...
		if (botonPulsado == btnVerFichaDel) {
			...
			try {
				if (tableArticulos.getSelectedRow() != -1) {
					...
					JFrameVerFicha objFicha = new JFrameVerFicha(Articulo,
							saberSiBusc, busqueda, ordenacion, adminOusu, 1);
		...
		if (botonPulsado == btnModificar) {
			...
			try {
				if (tableArticulos.getSelectedRow() != -1) {
					...
					case 0:
						JFrameModificarCD objModCD = new JFrameModificarCD(
								Articulo, saberSiBusc, ordenacion, busqueda);
						objModCD.setVisible(true);
						this.dispose();
						break;
					case 1:
						JFrameModificarDVD objModDVD = new JFrameModificarDVD(
								Articulo, saberSiBusc, ordenacion, busqueda);
						objModDVD.setVisible(true);
						this.dispose();
						break;
					case 2:
						JFrameModificarLibro objModLib = new JFrameModificarLibro(
								Articulo, saberSiBusc, ordenacion, busqueda);
						objModLib.setVisible(true);
						this.dispose();
						break;
					}
		...
		if (botonPulsado == btnNumero) {
			JFrameVerArticulos objVerArticulos = new JFrameVerArticulos(
					saberSiBusc, busqueda, 0, adminOusu);
			objVerArticulos.setVisible(true);
			this.dispose();
		}
		...
		if (botonPulsado == btnNombre) {
			JFrameVerArticulos objVerArticulos = new JFrameVerArticulos(
					saberSiBusc, busqueda, 1, adminOusu);
			objVerArticulos.setVisible(true);
			this.dispose();
		}
	}
	...
	public void mouseEntered(MouseEvent c) {
		...
		if (botonPulsado == btestrella1) {
			btestrella1.setIcon(new ImageIcon(getClass().getResource(
		...
		if (botonPulsado == btestrella2) {
			btestrella1.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella2.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella3) {
			...
			btestrella2.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella3.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella4) {
			...
			btestrella3.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella4.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella5) {
			...
			btestrella4.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella5.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella6) {
			...
			btestrella5.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella6.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella7) {
			...
			btestrella6.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella7.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella8) {
			...
			btestrella7.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella8.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella9) {
			...
			btestrella8.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella9.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
		...
		if (botonPulsado == btestrella10) {
			...
			btestrella9.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
			btestrella10.setIcon(new ImageIcon(getClass().getResource(
					"/images/star-full.png")));
