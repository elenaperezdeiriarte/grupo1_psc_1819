...
public class TableLibros extends AbstractTableModel {
	...
	public TableLibros(ArrayList<ClsLibro> a) {
		...
		for (ClsArticulo b : a) {
			...
			Object[] c = { new Integer(b.getNumero()),
					new String(b.getNombre()), new String(b.getAutor()),
					new String(nota), new String(estado),
	...
	public void setData(ArrayList<ClsArticulo> m) {
		...
		for (ClsArticulo b : m) {
			...
			Object[] c = { new Integer(b.getNumero()), new String(tipo),
					new String(b.getNombre()), new String(b.getAutor()),
					new Double(b.getNota()), new String(estado),
					new Integer(b.getContador()), };
			data[cont] = c;
			cont++;
		}
